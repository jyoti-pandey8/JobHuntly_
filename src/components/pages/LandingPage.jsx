...
const LandingPageComponent = () => {
  return (
    <>
      <HomeHeader />
      <div className="flex flex-col items-left   px-8 lg:px-10 lg:mx-10 md:mx-10 md:px-10 py-10  justify-top h-screen bg-gray-100 bg-home">
    <h1 className="lg:text-[70px] text-[35px] font-semibold leading-[1.0] mb-0">
    Discover
    <br/> more than <br/>
     
      <span className="lg:text-[70px] sm:text-[35px] text-custom-blue leading-[1.1]"> 5000+ Jobs
        
     </span>
     
     <Image src="/image/home/Group.png" alt="Image 1" className="mt-3 lg:w-[400px] md:w-[300px]" width={200} height={32} />
    </h1>
  
    <br />
    <p className="lg:text-[18px] md:text-auto text-[14px] text-gray-400 mt-0 lg:mt-4 md:mt-4 mb-4  ">
      Great platform for the job seeker that searching for 
      new career <br/>heights Lorem ipsum, dolor sit amet consectetur adipisicing elit.
    </p>
    ...
    <div className="w-full md:w-auto">
      <button
        className="w-fit md:w-auto bg-custom-indigo text-white hover:bg-blue-700 transition px-6 py-2  text-[16px]"
      >
        Search My Job
      </button>
    </div>
...
<div className="grid grid-cols-5 gap-4  px-2  lg:px-10 lg:mx-10 md:mx-10 md:px-10 min-w-[1000px] "> 
  ...
  <div className="bg-gray-100 rounded-lg  ">
    <Image src="/image/home/explore/vodafone.png" alt="Image 1" className="" width={153} height={40}    />
  </div>
  <div className="bg-gray-100 rounded-lg ">
    <Image src="/image/home/explore/intel.png" alt="Image 2" className="" width={82} height={32} />
  </div>
  <div className="bg-gray-100 rounded-lg ">
    <Image src="/image/home/explore/tesla.png" alt="Image 3" className="w-auto" width={182} height={23} />
  </div>
  <div className="bg-gray-100 rounded-lg ">
    <Image src="/image/home/explore/amd.png" alt="Image 4" className="" width={116} height={28}/>
  </div>
  <div className="bg-gray-100 rounded-lg ">
    <Image src="/image/home/explore/talkit.png" alt="Image 5" className="" width={108} height={32} />
  </div>
...
<div className="flex flex-row justify-between items-center px-8 -my-60 lg:px-10 lg:mx-10 md:mx-10 md:px-10 h-screen bg-gray-100 bg-home">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-4 gap-8 -mt-65 md:-mt-50  lg:-mt-50 px-8 lg:px-10 lg:mx-10 md:mx-10 md:px-10 rounded shadow">
        {exploreData.map((item, index) => (
          <div
            key={index}
            className="bg-home text-center shadow-lg ring-1 ring-gray-200"
          >
            <ExploreCard
